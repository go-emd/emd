...
## Install and Use
1. export GOPATH=<path to root>/Go-Emd:$GOPATH
2. Download the Emd-Examples repo and begin playing.
...
### NOTE: Stability of releases will be guaranteed when the 1.0.0 release is finalized.
